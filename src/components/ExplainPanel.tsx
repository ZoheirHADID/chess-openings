...
export default function ExplainPanel({ explanation, openingName, eco, outOfBook }: Props) {
  if (!explanation) {
    return (
      <div className="space-y-3">
        <h3 className="text-xs font-semibold tracking-wide text-slate-400 uppercase">Pourquoi ce coup ?</h3>
        <p className="text-xs text-slate-500">
          Jouez un coup sur l’échiquier ou choisissez une branche : l’idée du coup s’affiche ici.
        </p>
      </div>
    )
  }
